...
import { selectTimerStarted, selectTimerColor, selectTimerExerciseTime, 
    selectTimerPaused } from '../../redux/timer/timer.selectors';
    ...
    return (
        <div className='timer' style={{color: timerColor}}>
            <TimerMachine 
                ...
                countdown={true}
                formatTimer={(time, ms) =>
                    moment.duration(ms, "milliseconds").format("ss")
                    }
                paused={paused}
                started={started}
